        ...
        <div id="MapInfo">
            <div style="width:400px;">
                <article class="card" style="padding-top: 20px">
                    <header>
                        <div align="left">
                            <form method="post" action="/restaurant/register" style="width: 260px">
                                <div style="background-color: #fff;border: 1px solid #d8dee2;padding: 20px">
                                    <div style="color:#666;line-height:25px;">当前坐标点如下：</div>
                                    <label for="pointInput"><input type="text" name="pointInput" readonly="readonly" id="pointInput" class="pointInput" style="display:inline-block;background:#EBEBE4;border:#7F9DB9 solid 1px;color:#555;width:160px;height:30px;line-height:30px;font-size:14px;font-weight:700" value="118.790886,32.06268"></label>
